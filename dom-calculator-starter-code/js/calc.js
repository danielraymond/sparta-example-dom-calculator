...
// set-up the event listeners for buttons on the page
function setupListeners() {
  ...
  // seleact all the operators on the page
...
// setting the listeners for the operators
function setOperatorButtonListeners(operators) {
  // location of calculator screen
  var calculatorScreen = document.getElementById('screen');
  // create a loops to set a listener on each button
